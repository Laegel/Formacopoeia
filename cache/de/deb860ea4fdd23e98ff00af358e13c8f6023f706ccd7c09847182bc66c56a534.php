...
<script data-tab="editor">formacopoeia.components.editor = 
{
    ...
    onActive: function() {
        ...
        srcdoc += '<div id="choices" style="display: none"><button class="new-field" data-field="text">Text</button><button class="new-field" data-field="submit">Submit</button></div>';
        for (var i = 0; i < formacopoeia.fields.length; ++i) {
            console.log(formacopoeia.fields[i])
        }
...
class __TwigTemplate_419d3760ce13d84821bab27e0e86b3b371532cf89280894852cd5785932cce98 extends Twig_Template
{
...
<script data-tab=\"editor\">formacopoeia.components.editor = 
{
    ...
    {
        return array (  190 => 11,  185 => 9,  182 => 8,  171 => 6,  167 => 5,  162 => 3,  158 => 1,);
    }
