    ...
    onActive: function() {
        ...
        domReady(function() {
            ...
            var togglePropertiesBlock = function(id) {
                ...
                for (var prop in formacopoeia.fields[self.getFieldById(id).type].props) {
                ...
                selectAll('input', fieldPropertiesBlock).on('input', (function(id) {
                    return function() {
                        ...
                        select('field-wrapper[data-id="' + id + '"]', iframeDoc).innerHTML = self.renderTemplate(formacopoeia.fields[self.getFieldById(id).type].template, self.getFieldById(id).props);
                    }
                })(id));
            };
            ...
            for (var index in formacopoeia.currentForm) {
                form.innerHTML += '<field-wrapper data-id="' + formacopoeia.currentForm[index].id + '">' + self.renderTemplate(formacopoeia.fields[formacopoeia.currentForm[index].type].template, formacopoeia.currentForm[index].props) + '</field-wrapper>';
            }
            ...
            toArray(buttonsNewField).forEach(function(item) {
                item.addEventListener('click', function() {
                    ...
                    form.innerHTML += '<field-wrapper data-id="' + id + '">' + formacopoeia.fields[this.dataset.field].template + '</<field-wrapper>';
...
class __TwigTemplate_de124523302d477be26fe96546c72183fb9fb4b2f80108fbd4ba1510ed97ec2e extends Twig_Template
{
    ...
    <div>
        ...
        ";
        // line 4
        echo twig_escape_filter($this->env, call_user_func_array($this->env->getFilter('dump')->getCallable(), array((isset($context["themes"]) ? $context["themes"] : null))), "html", null, true);
        echo "
        <select id=\"fc-theme\">
            ";
        // line 6
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["theme"]) {
            // line 7
            echo "                <option value=\"";
            echo twig_escape_filter($this->env, $this->getAttribute($context["theme"], "key", array()), "html", null, true);
            echo "\">";
...
<script data-tab=\"editor\">formacopoeia.tabs.editor = 
{
    ...
    {
        return array (  210 => 12,  205 => 10,  202 => 9,  191 => 7,  187 => 6,  182 => 4,  178 => 3,  174 => 1,);
    }
