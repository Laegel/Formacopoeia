...
<script data-tab="editor">formacopoeia.components.editor = 
{
    ...
    onInit: function() {
        var template = Twig.compile({
            data: 'The {{ baked_good }} is a lie.'
        });

        console.log(
            template({baked_good: 'cupcake'}, {filename: ''})
        );
    },
    onActive: function() {
        var self = this;
            ...
            var togglePropertiesBlock = function(id) {
                ...
                var callback = (function(id) {
                    return function(e) {
                        ...
                        console.log(field.options.props[this.dataset.prop])                 
...
class __TwigTemplate_979835b8a3b65360ad22cdfe4c5d9e374600ebef157714f24cd479e263bdda67 extends Twig_Template
{
...
<script data-tab=\"editor\">formacopoeia.components.editor = 
{
    ...
    onInit: function() {
        var template = Twig.compile({
            data: 'The ";
        // line 41
        echo twig_escape_filter($this->env, (isset($context["baked_good"]) ? $context["baked_good"] : null), "html", null, true);
        echo " is a lie.'
        });
...
<script data-tab=\"editor\">formacopoeia.components.editor = 
{
    ...
    {
        return array (  245 => 41,  212 => 11,  207 => 9,  204 => 8,  193 => 6,  189 => 5,  184 => 3,  180 => 1,);
    }
