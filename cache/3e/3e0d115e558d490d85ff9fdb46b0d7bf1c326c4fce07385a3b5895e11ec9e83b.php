        ...
        domReady(function() {
            ...
            var togglePropertiesBlock = function(id) {
                ...
                for (var prop in field.options.props) {
                    // PROP TYPES
                    propertiesString += resolvePropTypes(prop, field.name, self.getFieldById(id).props[prop]) + '<br>';
...
class __TwigTemplate_bb9ab2dc6d64a55b83e7852c726a3494d210cbfa1487a2edd6cd817175fd7138 extends Twig_Template
{
