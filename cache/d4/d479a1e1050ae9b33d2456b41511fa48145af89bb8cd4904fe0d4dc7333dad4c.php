        ...
        domReady(function() {
            ...
            var togglePropertiesBlock = function(id) {
                ...
                for (var prop in field.options.props) {
                    // PROP TYPES
                    console.log(prop)
                    propertiesString += self.resolvePropTypes(prop, prop.type, self.getFieldById(id).props[prop]) + '<br>';
...
class __TwigTemplate_d4cc80127b8b3f17248517fa489a70baccbf5107d62fc3756467af5d45631440 extends Twig_Template
{
