        ...
        domReady(function() {
            ...
            var togglePropertiesBlock = function(id) {
                ...
                for (var prop in field.options.props) {
                    // PROP TYPES
                    propertiesString += self.resolvePropTypes(prop, field.name, self.getFieldById(id).props[prop]) + '<br>';
...
class __TwigTemplate_0d16e0285217805e3ef50261b1d6d9ebb2c121dde1adb197a54199ff12fa32a3 extends Twig_Template
{
...
<script data-tab=\"editor\">formacopoeia.components.editor = 
{
    ...
    {
        return array (  204 => 11,  199 => 9,  196 => 8,  185 => 6,  181 => 5,  176 => 3,  172 => 1,);
    }
