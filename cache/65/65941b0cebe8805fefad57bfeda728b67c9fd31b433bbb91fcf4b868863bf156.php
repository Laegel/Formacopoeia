    ...
    onActive: function() {
        ...
        domReady(function() {
            ...
            self.themeSelector.on('change', function() {
                ...
                console.log(formacopoeia.themes, this.value)
            });
            ...
            var togglePropertiesBlock = function(id) {
                ...
                selectAll('input', fieldPropertiesBlock).on('input', (function(id) {
                    return function() {
                        ...
                        select('field-wrapper[data-id="' + id + '"]', iframeDoc).innerHTML = self.renderTemplate(field.options.template, formField.props);
                    }
                })(id));
            };
            ...
            for (var index in formacopoeia.currentForm) {
                ...
                form.innerHTML += '<field-wrapper data-id="' + formacopoeia.currentForm[index].id + '">' + self.renderTemplate(field.options.template, formacopoeia.currentForm[index].props) + '</field-wrapper>';
            }
...
class __TwigTemplate_d99d26c51fcb90c1e07efadec341d8bf221371737294b7cf9e91b676ac49510f extends Twig_Template
{
...
<script data-tab=\"editor\">formacopoeia.tabs.editor = 
{
    ...
    {
        return array (  211 => 11,  206 => 9,  203 => 8,  192 => 6,  188 => 5,  183 => 3,  179 => 1,);
    }
